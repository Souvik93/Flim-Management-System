...
*/
	...
	public void testRemoveActorSuccesful() throws ParseException {
		...
		Actor a1=new Actor();
		String udob="1993-02-01";
		java.util.Date oldDob = formatter.parse(udob);
		a1.setFirstName("Souvik");
		a1.setDob(oldDob);
